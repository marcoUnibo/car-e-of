...
app.get("/persons/:idPerson", (req, res) => {
...
app.get("/searchPersonSurname", (req, res) => {
...
app.get("/searchPersonRole", (req, res) => {
	const { query, limit} = req.query
	let personsFiltered = [...persone]
	if (query) {
		personsFiltered = personsFiltered.filter((person) => {
...
app.get("/searchPersonId", (req, res) => {
	const { query, limit} = req.query
	let personsFiltered = [...persone]
	if (query) {
		personsFiltered = personsFiltered.filter((person) => {
...
app.put("/persons/:idPerson", (req, res) => {
	const {idPerson} = req.params
	const singlePerson = req.body
...
app.delete("/persons/:idPerson", (req, res) => {
	const {idPerson} = req.params
	const index = persone.findIndex(singlePerson => singlePerson.id === idPerson)
